...
@st.cache_data
def filter_top_holdings(df_filtered, holdings_filter_option):
    ...
    if holdings_filter_option == 'Top 5 holdings':
        top_holdings = df_end_date_sorted['Ticker'].head(5).unique()
        df_filtered = df_filtered[df_filtered['Ticker'].isin(top_holdings)]
    elif holdings_filter_option == 'Top 10 holdings':
        top_holdings = df_end_date_sorted['Ticker'].head(10).unique()
        df_filtered = df_filtered[df_filtered['Ticker'].isin(top_holdings)]
...
if selected_option:
    ...
    # Filter for top X holdings
    df_filtered = filter_top_holdings(df_filtered, holdings_filter_option)
